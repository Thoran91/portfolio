    ...
    <div className="App">
      ...
      <div class="container">
        ...
        <footer className="app-footer d-flex">
          <a href="mailto:tomhoran91@gmail.com"><i class="fas fa-envelope email-red fa-2x"></i>thorandev91@gmail.com</a>
          <a href="https://www.linkedin.com/in/tom-horan/"><i class="fab fa-linkedin linkedin-blue fa-2x"></i>LinkedIn</a>
          <a href="https://github.com/Thoran91"><i class="fab fa-github-square github-purple fa-2x"></i>GitHub</a>
        </footer>
      </div>
    </div>
